 ...
 * @author Javier
 */
public class RegistrarEscuelaFrame extends javax.swing.JFrame {

	private final GestorEscuela gestor;

    /**
     * Creates new form RegistrarEscuelaFrame
     */
	public RegistrarEscuelaFrame(GestorEscuela gestor) {
		this.gestor = gestor;
        initComponents();
    }
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
		...
		if (validarRequerido("Nombre", nombre) &&
			...
			Escuela escuela = new Escuela(nombre, direccion);
			gestor.registrarEscuela(escuela);
			dispose();
		}
